...
Tài liệu bài giảng và thực hành môn Big Data & Cloud Computing.

## Bài giảng

- `Lectures/Lecture 1 – Introduction to Big Data.pptx`: Chương 1 — Tổng quan về Big Data.
- `Lectures/Lecture 2 Hadoop.pptx`: Chương 2 — DFS, HDFS, YARN và MapReduce.

## Thực hành Chương 2

Thư mục `src/hadoop_colab_practical/` gồm:
...
Xem `CHUONG_2_REVISION_NOTES.md` để biết nội dung đã hiệu đính.
